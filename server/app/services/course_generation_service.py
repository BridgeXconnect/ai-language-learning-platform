"""
Course Generation Service - Main orchestrator for AI-powered course creation.
Combines RAG, AI services, and document processing to generate complete courses.
"""
